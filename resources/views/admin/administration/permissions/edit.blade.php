...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mt-0 header-title">Edit Permission</h4>
                <form class="forms-sample" id="ic_permission_add" action="{{route('admin.permissions.update', $permission->id)}}" method="POST"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div>
                                <input type="text" id="group_name" value="{{ $permission->group_name }}" class="form-control" name="group_name"
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            ...
                            <div>
                                <input type=" text" id="name" value="{{ $permission->name }}" class="form-control" name="name"
